...
class Accordian {
    ...
    collapse(){
        if(this.autoClose){
            const currentPanel = this.accordian.querySelector('.panel-content','.toggle-on')
            if (currentPanel) {
...
class Panel {
    constructor(panel, parentAccordian) {
        ...
        // console.log(this.panelButtons)
        this.openButton = this.panel.querySelector('.panel-btn-open')
        // console.log(this.openButton)
         this.closeButton = this.panel.querySelector('.panel-btn-close')
